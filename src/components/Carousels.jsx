        ...
        <CarouselContent className="ml-0 h-[30vh] md:h-[80vh] ">
          {profile.map((item, index) => (
            <CarouselItem
              ...
              className="  bg-cover bg-center pt-5 bg-no-repeat relative pointer-events-none"
            >
                ...
                <Card className="bg-transparent border-none">
                  <CardContent className="flex items-center justify-center p-6">
                    <div className="h-[40vh] md:h-[60vh] flex lg:justify-center items-center relative">
                      <p className="text-white text-base -mt-20 sm:-mt-20 sm:text-lg md:text-xl lg:text-2xl  text-center w-10/12 md:w-8/12">
                        <span>{item.text}</span>
                      </p>
                    </div>
                  </CardContent>
